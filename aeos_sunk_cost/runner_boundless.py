...
SAFETY_MAX_ITERATIONS = 100  # 100 ITERATION CEILING
MIN_ITERATIONS_BEFORE_STOP = 5
STAGNATION_PATIENCE = 999999  # NEVER FORCED PIVOT
TIMEOUT_PER_ITERATION = 300  # seconds (5 min — enough for neural networks)


def run_experiment(backend="ollama", model_name="gemma4", api_key=None, dataset="tabular", n_samples=10000):
    ...
    if backend == "ollama":
        ...
        agent = AutonomousAgent(api_key=key, model=model_name, dataset_hint=dataset_hint)
